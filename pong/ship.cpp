...
void Ship::create(GLuint program) {
  ...
  m_rotation = 0.0f;
  m_translation = glm::vec2(+1.0f,0.0f);
  m_translationO = glm::vec2(-1.0f,0.0f);
  m_velocity = glm::vec2(0);

  // clang-format off
  std::array positions{
      // Ship body
      glm::vec2{-2.5f, +10.0f},glm::vec2{+2.5f, +10.0f},
      glm::vec2{+2.5f, -10.0f},glm::vec2{-2.5f, -10.0f},
      };
...
void Ship::paint(const GameData &gameData, int type) {
  ...
  if(type==1)
  {
	abcg::glUniform2fv(m_translationLoc, 1, &m_translation.x);
  	...
  	abcg::glUniform2fv(m_translationLoc, 1, &m_translationO.x);
  }
